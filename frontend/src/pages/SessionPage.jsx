...
const SessionPage = () => {
  ...
  // redirect the participant when session end
  useEffect(() => {
        ...
        <Group orientation="horizontal">
          ...
          <Panel defaultSize={"50%"} minSize={"30%"}>
            <Group orientation="vertical">
              ...
              <Separator className="h-1 bg-base-300 hover:bg-primary transition-colors cursor-row-resize" />
          ...
          <Separator className="w-1 bg-base-300 hover:bg-primary transition-colors cursor-col-resize" />
