...
const RecentSessions = ({ sessions, isLoading }) => {
  return (
    <div className="bg-base-100 card border border-primary/20 hover:border-primary/60 transition-colors duration-200 mt-8">
      <div className="card-body">
        {/* HEADER */}
        <div className="mb-6 flex items-center gap-3">
          <div className="size-8 flex items-center justify-center bg-success rounded-xl">
            <Clock className="size-4 text-white" />
          </div>
          <span className="text-base-content font-bold text-2xl">
            Your Past Sessions
          </span>
        </div>
        {/* RECENT LIST */}
